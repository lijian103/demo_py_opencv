...
def cos_wave(initial_phase=0,Period=70):
    ...
    cv2.imwrite("./cos_pictures/"+"cos_wave"+"_initial_phase_"+str(initial_phase)+"_Period_"+str(Period)+".bmp",cos_wave)
    cv2.imshow("cos_wave"+"_initial_phase_"+str(initial_phase)+"_Period_"+str(Period),cos_wave)




def sin_wave(initial_phase=0,Period=2*70):
    """
    """
    x_axis_sin= np.linspace(initial_phase, np.pi * Period + initial_phase, Image_cols)
...
def fringe_wave_cross(initial_phase=0 , Period=40):
    """
    """
    x_axis_sin= np.linspace(initial_phase, np.pi * Period+initial_phase, Image_rows)
